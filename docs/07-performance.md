...
| Large schema (100 defs, 50 rules) | 5,500/sec | 180 µs | 199 KB |

### Verify (Audit)

| Benchmark | Throughput | Latency | Memory |
|-----------|------------|---------|--------|
| Typical schema | 6,600/sec | 150 µs | 127 KB |
| Parallel (14 cores) | 11,700/sec | 85 µs | 130 KB |
...
| API batch processing | 1000/sec | 40,000/sec | 6,600/sec | ✅ |
